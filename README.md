...
- [pre-commit] of linting([flake8]), formatting([black], [isort]) and type-checking([mypy])
- pytest ([pytest], [pytest-cov] and [pytest-describe])
- GitHub Actions workflows ([test](./.github/workflows/test.yml) and [release-drafter][release-drafter])
- [dependabot] managing GitHub Actions and Python dependencies
...
[github-template-repository]: https://docs.github.com/ja/repositories/creating-and-managing-repositories/creating-a-template-repository
